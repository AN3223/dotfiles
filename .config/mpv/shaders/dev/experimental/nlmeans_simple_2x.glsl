...
// Description: experimental/nlmeans_simple_2x.glsl: Upscale without actually running the NLM algorithm

//!HOOK LUMA
//!BIND HOOKED
//!DESC Non-local means (experimental/nlmeans_simple_2x.glsl)
//!WIDTH HOOKED.w 2 *
//!HEIGHT HOOKED.h 2 *
