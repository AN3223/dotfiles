...
// Description: experimental/nlmeans_ffmpeg_eqv.glsl: Should be roughly equivalent to ffmpeg's -vf=nlmeans (for debugging)
...
#ifdef LUMA_raw
#define SST 0
#define SS 0.4896610385205902
#define PST 0
#define PSS 0.0
#else
#define SST 0
#define SS 0.31590309191489624
#define PST 0
#define PSS 0.0
#endif
