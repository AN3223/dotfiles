...
// Description: experimental/nlmeans_light.glsl: Tuned for light noise.
...
#ifdef LUMA_raw
#define S 0.900953584081245
#else
#define S 1.6567339233122111
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.6271286518808608
#else
#define SW 1.1838585874060035
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.3580807875953441
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.4755651765517312
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.23708769235503246
#define WDP 1.402517980462444
#define WDS 1.0
#else
#define WD 1
#define WDT -0.01477279915492617
#define WDP 7.306250482515326
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 1.657228212695381e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
//!BIND RF_LUMA
//!BIND RF
//!DESC Non-local means (experimental/nlmeans_light.glsl)
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.997422283157854
#else
#define S 0.3603167421979498
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.5128465981014585
#else
#define SW 1.0532038019269845
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.9041581461196312
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.05889535709269464
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 0.00012631170674416706
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 1.4577730296275059e-05
#define PSO 0.0
#define ASO 0.0
#endif
