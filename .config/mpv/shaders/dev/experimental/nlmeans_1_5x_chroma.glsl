...
// Description: experimental/nlmeans_1_5x_chroma.glsl: Experimental upscaler
...
//!BIND HOOKED
//!BIND GC
//!DESC Non-local means (experimental/nlmeans_1_5x_chroma.glsl)
//!WIDTH HOOKED.w 1.5 *
//!HEIGHT HOOKED.h 1.5 *
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.3011365475909978
#define ASA 0.2725773792459882
#define ASP 1.0520917455458265
#define ASS 0.4706657978611998
#define ASI 0
#else
#define AS 1
#define ASF 0.3011365475909978
