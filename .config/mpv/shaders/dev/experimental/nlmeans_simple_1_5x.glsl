...
// Description: experimental/nlmeans_simple_1_5x.glsl: Upscale without actually running the NLM algorithm
...
//!BIND HOOKED
//!BIND G
//!DESC Non-local means (experimental/nlmeans_simple_1_5x.glsl)
//!WIDTH HOOKED.w 1.5 *
//!HEIGHT HOOKED.h 1.5 *
