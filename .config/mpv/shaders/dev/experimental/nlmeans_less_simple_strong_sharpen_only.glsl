...
// Description: experimental/nlmeans_less_simple_strong_sharpen_only.glsl: Sharpen without regard to noise

//!HOOK LUMA
//!HOOK CHROMA
//!BIND HOOKED
//!DESC Non-local means (experimental/nlmeans_less_simple_strong_sharpen_only.glsl)
...
#ifdef LUMA_raw
#define S 0.5207404586659704
#else
#define S 0.5915457055369318
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 2.0823282408956834
#define ASA 0.2905086472771023
#define ASP 0.9838340094360918
#define ASS 0.1692634296152981
#define ASI 0
#else
#define AS 2
#define ASF 1.0245083382555902
#define ASA 0.2632838810724828
#define ASP 0.9716675025501743
#define ASS 0.0188427128853579
#define ASI 0
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.881208937322981
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.8488075830034876
#define PST 0
#define PSS 0.0
#endif
