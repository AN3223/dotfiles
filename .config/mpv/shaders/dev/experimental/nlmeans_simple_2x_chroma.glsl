...
// Description: experimental/nlmeans_simple_2x_chroma.glsl: Upscale without actually running the NLM algorithm

//!HOOK CHROMA
//!BIND HOOKED
//!DESC Non-local means (experimental/nlmeans_simple_2x_chroma.glsl)
//!WIDTH HOOKED.w 2 *
//!HEIGHT HOOKED.h 2 *
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.1947115906830512
#define ASA 0.18515396018432093
#define ASP 0.8910334029060953
#define ASS 0.6461906244689197
#define ASI 0
#else
#define AS 1
#define ASF 0.1947115906830512
