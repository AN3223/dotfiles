...
// Description: experimental/nlmeans_simple_1_5x_chroma.glsl: Upscale without actually running the NLM algorithm
...
//!BIND HOOKED
//!BIND GC
//!DESC Non-local means (experimental/nlmeans_simple_1_5x_chroma.glsl)
//!WIDTH HOOKED.w 1.5 *
//!HEIGHT HOOKED.h 1.5 *
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.20030425105680133
#define ASA 0.18768574400307442
#define ASP 0.9357218741535395
#define ASS 0.6351050392159252
#define ASI 0
#else
#define AS 1
#define ASF 0.20030425105680133
