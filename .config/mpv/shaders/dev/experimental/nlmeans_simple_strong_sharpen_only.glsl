...
// Description: experimental/nlmeans_simple_strong_sharpen_only.glsl: Sharpen without regard to noise and without actually running the NLM algorithm

//!HOOK LUMA
//!HOOK CHROMA
//!BIND HOOKED
//!DESC Non-local means (experimental/nlmeans_simple_strong_sharpen_only.glsl)
...
#ifdef LUMA_raw
#define AS 2
#define ASF 2.926106499700339
#define ASA 0.24648970532505318
#define ASP 0.8494893713671743
#define ASS 0.10015646791976276
#define ASI 0
#else
#define AS 2
#define ASF 4.685343414839715
#define ASA 0.1304936228310675
#define ASP 0.9170631200063287
#define ASS 0.022704024768506092
#define ASI 0
#endif
