...
// Description: nlmeans_light_temporal.glsl: Very experimental and buggy, limited to vo=gpu-next. Tuned for light noise.
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.3188851369878764
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.4044677859113607
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.6293294687014377
#define WDP 0.6959543123933697
#define WDS 1.0
#else
#define WD 0
...
//!BIND PREV1
//!BIND PREV2
//!DESC Non-local means (nlmeans_light_temporal.glsl)
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.0270170582844775
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.022913470921480283
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 7.029563872179932e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 4.1823457731879414e-08
#define PSO 0.0
#define ASO 0.0
#endif
