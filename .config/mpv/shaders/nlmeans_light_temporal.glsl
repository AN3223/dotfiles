...
#ifdef LUMA_raw
#define S -2.6059098714720082e+177
#else
 ...
 */
#ifdef LUMA_raw
#define SW 1.2742342993642947e+177
#else
...
#ifdef LUMA_raw
#define SST 1
#define SS 5.081093938711539e+174
#define PST 0
#define PSS 0.0
#else
#define SST 1
...
#ifdef LUMA_raw
#define WD 1
#define WDT -9.130316174050182e+176
#define WDP 4.923798352192082e+177
#define WDS 1.0
#else
#define WD 1
...
#ifdef LUMA_raw
#define SO 0.0
#define RO -4.8221564505718773e+173
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S -3.3499405556318697e+182
#else
 ...
 */
#ifdef LUMA_raw
#define SW 3.090042973752596e+179
#else
...
#ifdef LUMA_raw
#define SST 1
#define SS -9.659014177496574e+174
#define PST 0
#define PSS 0.0
#else
#define SST 1
...
#ifdef LUMA_raw
#define WD 2
#define WDT 2.99631834262823e+180
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 1.2991320167407807e+172
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
