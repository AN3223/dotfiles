...
#ifdef LUMA_raw
#define S 3.521739385197952
#else
#define S 2.083552022106632
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.1637130245483474
#else
#define SW 0.7582283996443954
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.2148847608102409
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.57791092022341
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.238950815230622
#define WDP 1.7319346291204374
#define WDS 1.0
#else
#define WD 1
#define WDT 0.4014388098905747
#define WDP -0.012586754797932703
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO -7.197073331903007e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 0.7432870081467897
#else
#define S 0.39613409172470726
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.4425274035540643
#define ASA 0.02091276768359805
#define ASP 0.9161436680448176
#define ASS 0.23507685656413738
#define ASI 0
#else
#define AS 1
#define ASF 0.16332351741157192
#define ASA 0.4374046439811962
#define ASP 0.7354638088052133
#define ASS 0.020076187693987113
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.7938944818470302
#else
#define SW 0.7520886208704873
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.3268985859903106
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.04351922231956818
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT -0.00034730074610365264
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 7.035368667798719e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 1.940606613841268e-05
#define PSO 0.0
#define ASO 0.0
#endif
