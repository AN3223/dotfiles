...
#ifdef LUMA_raw
#define S 0.06890569351643297
#else
#define S -0.008687661704444228
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.29765763888827695
#else
#define SW 16.469182083075744
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.32933019939912456
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.22695939249357133
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.7028554075927236
#define WDP 15.954072979925787
#define WDS 1.0
#else
#define WD 0
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 5.634549711897555e-07
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 3.729107355365732
#else
#define S -0.8269188728441862
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.8972384557771782
#define ASA 0.16560469892133284
#define ASP 1.09935824026847
#define ASS 0.1583579033384476
#define ASI 0
#else
#define AS 2
#define ASF -0.001047679309363966
#define ASA 0.10390003588319456
#define ASP 5.577257585522298
#define ASS 0.24610310324180326
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.18971285068064248
#else
#define SW 0.07846995864338238
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.2784425287552565
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.011830858837553302
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 5.0212690567311355e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 0.00015959591701428336
#define PSO 0.0
#define ASO 0.0
#endif
