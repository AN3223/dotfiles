...
#ifdef LUMA_raw
#define S 0.4769582067332304
#else
#define S 0.004033812940170348
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.4595338629798866
#else
#define SW 1.483011239274471
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.1420092889823692
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.6730845520487208
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 1.1992683471243017
#define WDP 0.5843389259514211
#define WDS 1.0
#else
#define WD 0
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 4.795412079194737e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.947401130238823
#else
#define S -0.03521585847945996
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.5417774174405605
#define ASA 1.0103276027836496
#define ASP 1.1477951360371363
#define ASS 0.29745287454873287
#define ASI 0
#else
#define AS 2
#define ASF 5.693754965184495
#define ASA -0.1372616316203586
#define ASP 7.274123057849056
#define ASS -0.031286485569165697
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.7696890741264769
#else
#define SW 0.02268048553824336
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.17922123314856647
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS -0.014603316614072374
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.059807417701832254
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 4.353060844311638e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 4.815762828546297e-05
#define PSO 0.0
#define ASO 0.0
#endif
