...
#ifdef LUMA_raw
#define S 0.2504314036238052
#else
#define S 0.08460059191083458
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.2191022700443946
#else
#define SW -2.4168595576356426
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.31427175416835784
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.07180557755400485
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.6042087612154389
#define WDP 0.9903015779235212
#define WDS 1.0
#else
#define WD 1
#define WDT -0.5899634726816638
#define WDP -0.006202796320737643
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 0.00019360701130878027
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.7300608548510643
#else
#define S 1.1792390625480462
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.5699034721133138
#define ASA 2.453749512665383
#define ASP 1.2671333086326053
#define ASS -0.08561803388039749
#define ASI 0
#else
#define AS 2
#define ASF 5.918767191833328
#define ASA 1.2525359015501447
#define ASP 2.316555939397292
#define ASS 0.0913616774948148
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.9797510302190787
#else
#define SW 0.08547043437640825
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.13860220997602507
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 1.7266589369221714
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.06262345182918094
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 4.345334577550261e-06
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 5.963366230154387e-06
#define PSO 0.0
#define ASO 0.0
#endif
