...
#ifdef LUMA_raw
#define S 3.4985574550163454
#else
#define S 5.257927359652109
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.22236734674582598
#else
#define SW 0.36100269436836946
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.7618122933162241
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 1.4351283675990663
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.3758980049383349
#define WDP 3.335603276578435
#define WDS 1.0
#else
#define WD 1
#define WDT 1.0189582567142157
#define WDP 3.320120508616827
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 9.457170782577346e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 0.6945952335372921
#else
#define S 0.697101368446697
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.6121754710131926
#define ASA 2.422585492654911
#define ASP 1.007287662882105
#define ASS 0.35998838738862043
#define ASI 0
#else
#define AS 1
#define ASF 0.32823460998055437
#define ASA 1.208887388822689
#define ASP 0.990537777108177
#define ASS 0.020931562236285266
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 2.1148541977259003
#else
#define SW 1.5914637417797122
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.28290296232634166
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.06429069594653684
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.08419509693480409
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 4.497559804089183e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 4.550581930319608e-05
#define PSO 0.0
#define ASO 0.0
#endif
