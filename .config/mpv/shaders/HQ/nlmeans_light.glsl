...
#ifdef LUMA_raw
#define S 4.126191305027437
#else
#define S 2.4100584579707616
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.3519086230054841
#else
#define SW 0.7590160886909864
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.7715035787989077
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 1.100754300227108
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.5108159305426606
#define WDP 4.511212684837026
#define WDS 1.0
#else
#define WD 0
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 0.0001460509420278015
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 0.6872881480520366
#else
#define S 0.6051106279657003
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.8368153073631441
#else
#define SW 2.7580328880458036
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.21766114928355643
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.044008332875589314
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.09060497453198815
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 2.3058277111402457e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 2.5512408674271188e-05
#define PSO 0.0
#define ASO 0.0
#endif
