...
#ifdef LUMA_raw
#define S 5.636740557767719
#else
#define S 4.686595293513156
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.2295262950215209
#else
#define SW 0.47345375470892864
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.4747502628786866
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.5741131056194471
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.35008889267762927
#define WDP 2.6832399246567626
#define WDS 1.0
#else
#define WD 1
#define WDT 0.58050982489547
#define WDP 5.700069592496046
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 5.146167638997736e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.198179404207495
#else
#define S 0.9693359096767118
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.5545766003081553
#define ASA 2.1033830824929547
#define ASP 0.9599816980458803
#define ASS 0.32249461229442195
#define ASI 0
#else
#define AS 1
#define ASF 0.5907845527573137
#define ASA 1.2743814041681731
#define ASP 1.1249437967543077
#define ASS 0.044671303317395814
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.6759110956512266
#else
#define SW 1.7173159396890199
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.19119303733275106
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.09885418098779304
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.06272634447803307
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 3.233890151827361e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 9.803531452719585e-05
#define PSO 0.0
#define ASO 0.0
#endif
