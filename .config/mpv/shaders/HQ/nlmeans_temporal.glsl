...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.47292135256681533
#define WDP 3.5465032322544787
#define WDS 1.0
#else
#define WD 1
#define WDT 0.47292135256681533
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.4206838390752536
#else
#define S 0.912833678917114
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.5670210774306126
#else
#define SW 1.8548079412662708
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.16150288021955722
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.0657350768177042
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.09948300421165811
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 2.5735738796271048e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 0.0001063803725131554
#define PSO 0.0
#define ASO 0.0
#endif
