...
// Description: LQ/nlmeans_light_sharpen_only.glsl: Faster, but lower quality. Sharpen without denoising. Tuned for light noise.
...
#ifdef LUMA_raw
#define S 1.51962721980237
#else
#define S 1.7196714363955614
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.6171730665287706
#define ASA 0.32662593276065005
#define ASP 1.07731720217065
#define ASS 0.18222465721406353
#define ASI 0
#else
#define AS 2
#define ASF 1.738046250367828
#define ASA 0.08399924449414838
#define ASP 1.3671238707464652
#define ASS 0.032873251148599646
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.8758845270934598
#else
#define SW 0.08209359455010294
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.20664736079347282
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.15446544958951758
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.3150296564793732
#define WDP 0.5611070408611922
#define WDS 1.0
#else
#define WD 1
#define WDT 0.24365093859319764
#define WDP 7.3424424425375125
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 7.837890973113128e-06
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
