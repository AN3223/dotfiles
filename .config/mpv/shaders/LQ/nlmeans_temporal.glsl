...
#ifdef LUMA_raw
#define S 3.609375568535728
#else
#define S 4.960216447356352
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.7601969438287144
#else
#define SW 0.6309695642672088
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.5080278246358708
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.3333001009799326
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.524659871713829
#define WDP 4.3806083464417425
#define WDS 1.0
#else
#define WD 0
#define WDT 0.0
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 0.00010004319930275615
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
