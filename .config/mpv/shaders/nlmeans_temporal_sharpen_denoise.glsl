...
#ifdef LUMA_raw
#define S 5.920208761228677
#else
#define S 5.315099357076815
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.3225848262696187
#else
#define SW 0.7411314925890389
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.8357014301982689
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.15474853038648376
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.25251786414775856
#define WDP 2.5053450905703563
#define WDS 1.0
#else
#define WD 1
#define WDT 0.5521262670171232
#define WDP -0.19472164785464102
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO -4.253048296058351e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.1641042128958856
#else
#define S 0.7100402981474091
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.5910751985460035
#define ASA 0.02039154902812824
#define ASP 0.9476985432953176
#define ASS 0.21165288241238137
#define ASI 0
#else
#define AS 1
#define ASF 0.6848950263851707
#define ASA 1.7553433191215433
#define ASP 1.0009263257140604
#define ASS 0.05816009091086483
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.4135228962286417
#else
#define SW 0.4708192399418968
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.290617879871799
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.09557318125137441
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT -0.0006267614406682239
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 0.0001441662278741235
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 7.983297373032812e-05
#define PSO 0.0
#define ASO 0.0
#endif
