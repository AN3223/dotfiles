...
#ifdef LUMA_raw
#define S 0.5070347158578837
#else
#define S 1.6502008166324043
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.8816735982450579
#else
#define SW 2.985231691228801
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.15554354234039783
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.3544327018752436
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.3809546477001723
#define WDP 0.12183913793568799
#define WDS 1.0
#else
#define WD 1
#define WDT 0.027446409618689105
#define WDP 9.846271600213793
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 7.002758453784608e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.308249138233306
#else
#define S 1.0447030824010193
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.8810207629818441
#define ASA 1.8690884727261663
#define ASP 1.1476835469895803
#define ASS 0.30330578660204216
#define ASI 0
#else
#define AS 2
#define ASF 1.2648549386259778
#define ASA 0.33788418634983486
#define ASP 1.2935524934403786
#define ASS 0.09712775515415607
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.23240603118497688
#else
#define SW 0.25294411439834436
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.7216364066714751
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.11902607025453533
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.24927015355481216
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 9.157192581577457e-06
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 4.4861886116678565e-05
#define PSO 0.0
#define ASO 0.0
#endif
